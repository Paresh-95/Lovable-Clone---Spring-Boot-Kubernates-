package com.paresh.projects.lovable_clone.security;

import com.paresh.projects.lovable_clone.entity.Project;
import com.paresh.projects.lovable_clone.enums.ProjectPermission;
...
public class SecurityExpressions {
    ...
    public boolean canManageMembers(Long projectId){
        return hasPermission(projectId,ProjectPermission.MANAGER_MEMBERS    );
    }
